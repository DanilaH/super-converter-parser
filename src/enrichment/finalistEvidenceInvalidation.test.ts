  ...
  try {
    ...
    await publishEntrantCohortMetadata({
      ...
      summary: {
        ...
        finalistClusterCount: 0,
        rankingOccurrenceCount: 0,
        excludedRankingOccurrenceCount: 0,
        clusterDomainMembershipCount: 0,
        globalUniqueDomainCount: 0,
        crossClusterDomainCount: 0,
        knownDrDomainMembershipCount: 0,
        weakDomainMembershipCount: 0,
        withinClusterRepeatedDomainMembershipCount: 0,
