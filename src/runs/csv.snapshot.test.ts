...
function okResult(keyword: KeywordRecord): CollectionResult {
  return {
    ...
    serpRows: [
      { keyword: keyword.normalizedKeyword, position: 1, title: 't1', url: 'https://a.com', hostname: 'a.com', registrableDomain: 'a.com', dr: null, resultType: 'organic' },
      { keyword: keyword.normalizedKeyword, position: 2, title: 't2', url: 'https://b.com', hostname: 'b.com', registrableDomain: 'b.com', dr: null, resultType: 'organic' },
    ],
...
test('keywords.csv follows the operator column contract with zero vs missing values', async () => {
  ...
  store.commitKeyword(
    ...
    [
      { keyword: 'compare lists', position: 1, title: 'a', url: 'https://a.com', hostname: 'a.com', registrableDomain: 'a.com', dr: null, resultType: 'organic' },
      { keyword: 'compare lists', position: 2, title: 'b', url: 'https://b.com', hostname: 'b.com', registrableDomain: 'b.com', dr: null, resultType: 'organic' },
    ],
    'hit',
  );
...
test('serp.csv has one row per stored organic result in input and position order', async () => {
  ...
  const serp: SerpResult[] = [
    { keyword: 'standing desk', position: 2, title: 'b', url: 'https://b.com', hostname: 'b.com', registrableDomain: 'b.com', dr: null, resultType: 'organic' },
    { keyword: 'standing desk', position: 1, title: 'a', url: 'https://a.com', hostname: 'a.com', registrableDomain: 'a.com', dr: null, resultType: 'organic' },
  ];
  store.commitKeyword(
    runId,
    {
...
test('a CSV snapshot failure leaves the run resumable and a resume republishes all artifacts', async () => {
  ...
  for (const keyword of KEYWORDS.slice(1)) {
    cache.putKeyword({
      ...
      serpRows: [
        { keyword: keyword.normalizedKeyword, position: 1, title: 'cached', url: 'https://cached.com', hostname: 'cached.com', registrableDomain: 'cached.com', dr: null, resultType: 'organic' },
      ],
      collectedAt: '2026-01-01T00:00:00.000Z',
...
test('cached runs serialize through the same CSV contract as fresh runs', async () => {
  ...
  for (const keyword of KEYWORDS) {
    cache.putKeyword({
      ...
      serpRows: [
        { keyword: keyword.normalizedKeyword, position: 1, title: 'cached title', url: 'https://cached.com', hostname: 'cached.com', registrableDomain: 'cached.com', dr: null, resultType: 'organic' },
      ],
      collectedAt: '2026-01-01T00:00:00.000Z',
      storedAt: '2026-01-01T00:00:00.000Z',
      expiresAt: '2030-01-01T00:00:00.000Z',
...
test('a partial keyword appears in keywords.csv with its organic count', async () => {
  ...
  store.commitKeyword(
    ...
    [
      { keyword: 'compare lists', position: 1, title: 'a', url: 'https://a.com', hostname: 'a.com', registrableDomain: 'a.com', dr: null, resultType: 'organic' },
      { keyword: 'compare lists', position: 2, title: 'b', url: 'https://b.com', hostname: 'b.com', registrableDomain: 'b.com', dr: null, resultType: 'organic' },
      { keyword: 'compare lists', position: 3, title: 'c', url: 'https://c.com', hostname: 'c.com', registrableDomain: 'c.com', dr: null, resultType: 'organic' },
    ],
    'miss',
  );
  await writeSnapshots(store, runId, runDirectory, 'running');
