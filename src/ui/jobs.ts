...
export type UiJobKind = 'create_research' | 'resume_research' | 'shortlist_research' | 'repair_discovery' | 'append_batch';
...
type WorkflowJobKind = 'create_research' | 'resume_research' | 'shortlist_research';
